...
#         f.write('Mexican Food\n')
#         f.write('My Couch\n')
#         f.write('Video Games\n')
#         f.write('Cooking\n')

def write_favourites(my_favorite_things):
    """
    ...
    print(f"Your favorite things have been written to {FAVOURITES_FILE}")
...
if __name__ == "__main__":
    ...
    write_favourites(favorite_items)
